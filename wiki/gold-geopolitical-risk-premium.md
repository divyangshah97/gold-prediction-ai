...
**Summary**: Gold carries a geopolitical risk premium — a price component that rises during crises and compresses during de-escalation. As of July 6, 2026, gold is at **~$4,163** (+0.63% from July 3 $4,137). Iran: Khamenei buried July 9; MOU ceasefire Day ~16; nuclear talks pending; gold largely decoupled from conflict. **DXY 100.88** (+0.06% flat). MCX **₹1,46,730/10g** (−0.01% essentially flat from ₹1,47,720). 9d EMA ~$4,109; 50d SMA ~$4,392 — gold above 9d, below 50d (downtrend). Signal: **Wait (+1)**.
