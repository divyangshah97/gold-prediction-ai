...
**Summary**: Gold carries a geopolitical risk premium — a price component that rises during crises and compresses during de-escalation. As of July 13, 2026, gold is at **~$4,053.92** (−1.5% from July 10 $4,116; Sunday spot). Iran war **sharply re-escalating** — Trump declared ceasefire "over" (July 8); Hormuz tanker attacks; US struck Tehran; Iran retaliating on UAE/Kuwait/Bahrain. WTI surged **+4.3% to $74.71**. Gold NOT rising on geopolitical risk — oil→inflation→hawkish Fed channel dominates. 9d EMA ~$4,090 (est.); 50d EMA ~$4,320 (web search, TipRanks) — gold BELOW BOTH EMAs (downtrend, 50d>9d). MCX ref. **~₹1,44,760/10g** (July 10; MCX closed Sunday). Signal: **Wait (0)**.
