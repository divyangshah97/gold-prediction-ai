...
**Summary**: Gold carries a geopolitical risk premium — a price component that rises during crises and compresses during de-escalation. As of July 21, 2026, gold is at **~$4,022–$4,071** (recovering from 9-month lows; prior close $4,017.52). Iran: Strait of Hormuz CLOSED; US-Iran active conflict with no crossings via US route since July 15. Gold recovering modestly (+0.65% MCX) but still in safe-haven paradox: oil surge → inflation → hawkish Fed channel. 9d EMA **~$4,088** (est., declining); 50d EMA **~$4,270** (est.) — gold BELOW BOTH EMAs. MCX **₹1,42,314/10g** (+0.65%). Signal: **Wait (+2)**.
