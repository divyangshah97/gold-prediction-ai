...
**Summary**: The Federal Reserve's policy path, the US fiscal outlook, and real yield dynamics are key macro drivers of gold. **July 7 UPDATE**: Fed held at 3.50–3.75% (June 17). PCE inflation 3.6%. 9 of 18 FOMC officials project ≥1 hike in 2026. FOMC minutes released this week (key macro event). Next FOMC **July 28-29** (expected hold). Gold −0.37% to $4,148; DXY 100.91 (+0.03% flat). June NFP miss (57K) — September hike at 0% probability. CPI due July 14 (next key print). Macro factor = **Neutral (0)** (mixed: dovish jobs + hawkish inflation + JPMorgan caution on real rates sensitivity).
