...
**Summary**: The Federal Reserve's policy path, the US fiscal outlook, and real yield dynamics are key macro drivers of gold. **July 29 UPDATE**: FOMC decision due today 2:00pm EDT; hold at 3.50-3.75% is the base case (66-86% probability depending on source), but the underlying stance has turned **hawkish**, not dovish — June's dot plot revised the median 2026 rate projection UP (3.4%→3.8%) and the PCE inflation forecast UP (2.7%→3.6%), with 9 of 18 officials now projecting at least one hike this year. May CPI running at 4.2% YoY, and markets are pricing a rising (>1/3 per one source) probability of a hike at today's meeting itself, up sharply after the Iran attack lifted oil. Net: **Macro factor = Bearish (−1)**.
